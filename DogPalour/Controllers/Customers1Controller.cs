...
namespace DogPalour.Controllers
{
    public class Customers1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmailAddress,Firstname,LastName,Gender,PhoneNumber,Address,ConfirmPasswrod")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmailAddress,Firstname,LastName,Gender,PhoneNumber,Address,ConfirmPasswrod")] Customer customer)
        {
            if (ModelState.IsValid)
            {
